...
const PAIRS = [
  ...
  ['text-muted', 'surface-raised', 'normal', 'index.html:82 label in .panel:74, app-shell.css .shell-surface-copy'],
  ['text-primary', 'surface-subtle', 'normal', 'index.html:106 .toggle span in .toggle:103'],
  ['text-muted', 'surface-subtle', 'normal', 'index.html:107 .toggle small in .toggle:103, app-shell.css .shell-surface-kicker'],
