...
const PAIRS = [
  ...
  ['text-muted', 'surface-raised', 'normal', 'index.html:82 label in .panel:74, app-shell.css .shell-surface-copy and .studio-editor-copy'],
  ['text-primary', 'surface-subtle', 'normal', 'index.html:106 .toggle span in .toggle:103'],
  ['text-muted', 'surface-subtle', 'normal', 'index.html:107 .toggle small in .toggle:103, app-shell.css .shell-surface-kicker and .studio-editor-status'],
  ...
  ['text-on-accent', 'accent-soft', 'normal', 'index.html:88 button, app-shell.css .shell-route-tab.active'],
  ...
  ['border-strong', 'surface-subtle', 'ui', 'index.html:119 .takes a border, app-shell.css .shell-surface-kicker and .shell-surface-panel border'],
  ['accent', 'accent-soft', 'ui', 'app-shell.css .shell-route-tab.active border'],
  ['border-subtle', 'surface-raised', 'ui', 'app-shell.css .studio-editor-header and .studio-editor-compatibility-frame border'],
