...
const PAIRS = [
  ...
  ['text-on-accent', 'accent', 'normal', 'tokens.css pairing; the on-accent role over the accent fill'],
  ...
  ['focus-ring', 'clip-audio-top', 'ui', 'timeline.css:390 .tl-clip .wave b over .tl-clip.audio:330'],
...
const ALLOWLIST = new Set([
  ...
  'light|focus-ring|menu-surface',
  'light|focus-ring|surface-app',
  'light|focus-ring|surface-raised',
  'light|focus-ring|timeline-surface',
  ...
  'dark|text-on-accent|accent-soft',
