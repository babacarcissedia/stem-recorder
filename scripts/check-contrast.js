...
const PAIRS = [
  ...
  ['text-primary', 'surface-raised', 'normal', 'index.html:90 button.secondary, app-shell.css .shell-route-tab'],
  ['text-muted', 'surface-raised', 'normal', 'index.html:82 label in .panel:74, app-shell.css .shell-surface-copy, .studio-editor-copy, and .shell-timeline-lane-label'],
  ['text-primary', 'surface-subtle', 'normal', 'index.html:106 .toggle span in .toggle:103'],
  ['text-muted', 'surface-subtle', 'normal', 'index.html:107 .toggle small in .toggle:103, app-shell.css .shell-surface-kicker, .studio-editor-status, .shell-footer-copy, .shell-timeline-button, and .shell-timeline-ruler'],
  ...
  ['text-on-accent', 'accent-soft', 'normal', 'index.html:88 button, app-shell.css .shell-route-tab.active and .shell-timeline-clip'],
  ...
  ['border-strong', 'surface-raised', 'ui', 'index.html:84 select border, app-shell.css .shell-route-tab border'],
  ['border-strong', 'surface-subtle', 'ui', 'index.html:119 .takes a border, app-shell.css .shell-surface-kicker, .shell-surface-panel, and .shell-timeline-button border'],
  ['border-strong', 'surface-subtle', 'ui', 'app-shell.css .shell-timeline-preview border'],
  ['accent', 'accent-soft', 'ui', 'app-shell.css .shell-route-tab.active and .shell-timeline-clip border'],
  ['border-subtle', 'surface-raised', 'ui', 'app-shell.css .studio-editor-header, .studio-editor-react-shell, .studio-editor-compatibility-frame, and .shell-footer border'],
  ['border-strong', 'surface-subtle', 'ui', 'app-shell.css .studio-editor-status border'],
